      ...
      <table cellpadding="2" cellspacing="0" class="KT_tngtable">
        <thead>
          <tr class="KT_row_order">
            ...
            <th id="Username" class="KT_sorter KT_col_Username <?php echo $tso_listthanhvien1->getSortIcon('thanhvien.Username'); ?>"> <a href="<?php echo $tso_listthanhvien1->getSortLink('thanhvien.Username'); ?>"> Username</a> </th>
