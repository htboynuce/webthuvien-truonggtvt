...
<form id="thongke" name="thongke" method="get" action="admincp_thuthu.php">
  <input name="mod" type="hidden" id="mod" value="thongke" />
 <div id="formthongke_cen">
  
  
   <div align="center">
     <select name="key2" id="key2" style="120px">
       <?php
do {  
?>
...
?>
     ...
     <br />
     <br/>
     <select name="key3" id="key3" style="120px" wdg:subtype="DependentDropdown" wdg:type="widget" wdg:recordset="rs_nhomsach" wdg:displayfield="TenNhomSach" wdg:valuefield="MaNhomSach" wdg:fkey="MaLinhVuc" wdg:triggerobject="key2">
       <option selected="selected" value="All"> Tất cả</option>
     </select>
     <br />
     <br/>
     Từ ngày :
     <input name="key4" id="key4" value="" size="25" wdg:mondayfirst="true" wdg:subtype="Calendar" wdg:mask="<?php echo $KT_screen_date_format; ?>" wdg:type="widget" wdg:singleclick="true" wdg:restricttomask="yes" />
     Đến ngày :
     <input name="key5" id="key5" value="" size="25" wdg:mondayfirst="true" wdg:subtype="Calendar" wdg:mask="<?php echo $KT_screen_date_format; ?>" wdg:type="widget" wdg:singleclick="true" wdg:restricttomask="yes" />
     <br />
     <br />
     <input type="submit" onclick="MM_validateForm('key1','','R');return document.MM_returnValue" value="Thống kê" align="middle" />
    </div>
 </div>
</form>
</div>
