...
function Trigger_CheckUnique(&$tNG) {
  ...
  $tblFldObj->setTable("phieumuon");
  $tblFldObj->addFieldName("TenPhieuMuon");
  $tblFldObj->setErrorMsg("Tên phiếu mượn này đã có ! Vui lòng nhập tên khác !");
...
$ins_phieumuon->addColumn("NgayHetHanThe", "DATE_TYPE", "POST", "NgayHetHanThe");
...
$upd_phieumuon->addColumn("NgayHetHanThe", "DATE_TYPE", "POST", "NgayHetHanThe");
